...
class WP_Contact_Plugin {
    ...
    private function get_custom_icon_markup( $channel ) {
        ...
        $allowed_svg_tags = [
            ...
            'g'              => $shared_shape_attributes,
            'path'           => array_merge( [ 'd' => true ], $shared_shape_attributes ),
            'circle'         => array_merge( [ 'cx' => true, 'cy' => true, 'r' => true ], $shared_shape_attributes ),
            'ellipse'        => array_merge( [ 'cx' => true, 'cy' => true, 'rx' => true, 'ry' => true ], $shared_shape_attributes ),
            'rect'           => array_merge( [ 'x' => true, 'y' => true, 'width' => true, 'height' => true, 'rx' => true, 'ry' => true ], $shared_shape_attributes ),
            'line'           => array_merge( [ 'x1' => true, 'y1' => true, 'x2' => true, 'y2' => true ], $shared_shape_attributes ),
            'polyline'       => array_merge( [ 'points' => true ], $shared_shape_attributes ),
            'polygon'        => array_merge( [ 'points' => true ], $shared_shape_attributes ),
            'title'          => [],
            'desc'           => [],
            'defs'           => [],
            'clipPath'       => [ 'id' => true ],
            ...
            'use'            => array_merge( [ 'href' => true, 'xlink:href' => true ], $shared_shape_attributes ),
            'linearGradient' => [
                'id'             => true,
                'x1'             => true,
                'y1'             => true,
